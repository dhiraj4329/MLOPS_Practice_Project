...
class DataProcessor:
    ...
    def preprocess_data(self,df):
        try:
            ...
            logger.info('Dropping the unnessary columns')
    ...
    def balance_data(self, df):
        try:
            ...
            raise CustomException('Error while data balancing data', e)
    ...
    def select_features(self, df):
        try:
            ...
            logger.info("Feature selection is done")
    ...
    def save_data(self, df, file_path):
        try:
            logger.info('Saving our data to processed folder')
