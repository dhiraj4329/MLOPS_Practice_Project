...
class ModelTraining:
    ...
    def load_and_split_data(self):
        try:
            ...
            logger.info('Data is splitted successfully for model')
    ...
    def train_lgbm(self, X_train, y_train):
        try:
            ...
            logger.info('Staring Hyperparameter Tuning')
    ...
    def evaluate_model(self, model, X_test, y_test):
        try:
            ...
            logger.info(f"Reacall_score {recall}")
    ...
    def save_model(self, model):
        try:
            ...
            logger.info(f"Model is saved to {self.model_output_path}")
    ...
    def run(self):
        try:
            with mlflow.start_run():
                ...
                logger.info('Logging the train and test dataset to mlflow')
